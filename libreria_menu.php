...
if (isset($_SESSION["sesion_id_rol"])){
    ...
    if ($cuerp == false){
        echo" <img src='../cafeteria/logos/{$logo}'width='10%' >";
    }
    else {
        echo "<img src='privada/cafeteria/logos/{$logo}'width='10%' >";
    }
    ...
    foreach ($rs as $r =>$fila) {
        ...
        foreach ($rs2 as $t =>$fila2) {
            if ($grup == $fila2["grupo"]) {
                ...
                echo"<li><a onclick='location.href=\"SIS_CAFETERIA_2/".$fila2["contenido"]."\"' ' style='cursor:pointer;'>".$fila2["opcion"]."</a></li>";
            }
        }
        echo"</ul>";
        echo"</li>";
